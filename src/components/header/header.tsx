    ...
    return (
        <div className="flex flex-col md:flex-row-reverse sm:items-center w-full mb-32">
            ...
            <div className="flex flex-col items-center md:items-start p-4 md:ml-16 justify-center">
                ...
                <h3 className="text-ash font-poppins font-display text-center md:text-left font-medium md:mt-10 mt-8">
                    Aprenda, respeite e explore as tradições afro-brasileiras
                </h3>
